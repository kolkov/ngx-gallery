...
| imageAutoPlayPauseOnHover  | `boolean` | `false` | no | Enables or disables pouse auto play on hover |
...
| previewDownload  | `boolean` | `false` | no | Enables or disables downoad button |
